...
const features = [
  {
    icon: Recycle,
    title: "אריזה ידידותית לסביבה",
    description: "חומרים ניתנים למחזור ופירוק ביולוגי"
  },
  {
    icon: Leaf,
    title: "היפואלרגני",
    description: "בטוח לעור רגיש, ללא ניקל"
  },
  {
    icon: Flower2,
    title: "עיצוב ישראלי",
    description: "מעוצב בהשראה מקומית ואיכות ללא פשרות"
  },
  {
    icon: Globe,
    title: "עמידות למים",
    description: "מתאים לשימוש בים, בבריכה ובמקלחת"
  }
]
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-xl text-foreground mb-2 font-medium">
                    100% <span className="">סטיינלס סטיל 316l</span>
                  </h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    מיוצר מהחומרים האיכותיים ביותר לעמידות מקסימלית.
                  </p>
                </div>
              </div>
            </div>
        ...
        >
          ...
          >
            ...
            <h2 className={`font-serif-custom text-4xl leading-tight text-foreground mb-6 text-balance md:text-7xl ${headerVisible ? 'animate-blur-in opacity-0' : 'opacity-0'}`} style={headerVisible ? { animationDelay: '0.4s', animationFillMode: 'forwards' } : {}}>
              תכשיטים שנושמים.
            </h2>
            <p className={`font-sans-custom text-lg text-muted-foreground leading-relaxed mb-10 max-w-md ${headerVisible ? 'animate-blur-in opacity-0' : 'opacity-0'}`} style={headerVisible ? { animationDelay: '0.6s', animationFillMode: 'forwards' } : {}}>
              אנחנו מאמינים שתכשיטים צריכים להיות חלק טבעי ממך, לא משהו שצריך לדאוג לגביו. כל תכשיט מעוצב מתוך מחשבה על נוחות, עמידות וסטייל נצחי.
            </p>
