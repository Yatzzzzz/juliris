...
export default function ShopPage() {
  ...
  const categories = useMemo(() => getCategorySlugs(), [])
  const categoryDetails = useMemo(() => getAllCategories(), [])
  ...
  // Filter products using catalog helpers
  ...
  const getCategoryName = (slug: string) => {
    ...
    const cat = categoryDetails.find((c) => c.slug === slug)
      ...
      <div className="bg-card rounded-3xl overflow-hidden boty-shadow boty-transition group-hover:scale-[1.02]">
        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-2">
            <span className="text-lg font-medium text-foreground">{formatMoney(product.price)}</span>
